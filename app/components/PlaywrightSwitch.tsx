        ...
        content={
          <div className="px-1 py-1 max-w-xs">
            ...
            <div className="text-xs">
              Enable this if the website uses heavy JavaScript or is a Single
              Page Application (SPA). It renders pages like a real browser but
              is slower than the default method.
            </div>
          </div>
        }
      >
